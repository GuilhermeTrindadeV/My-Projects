<main class="content">
    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label for="confirm_password">Confime a senha</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="checkbox" id="is_admin" name="is_admin" 
                    class="form-check <?= $errors['is_admin'] ? 'is-invalid' : '' ?>"
                    <?= $is_admin ? 'checked' : '' ?>>
                <div class="invalid-feedback">
                    <?= $errors['is_admin'] ?>
                </div>
        ...
        <div class="text-center">
            <button class="btn btn-primary btn-lg mb-1">Salvar</button>
            <a href="/users.php" 
                class="btn btn-secondary btn-lg mb-1">Cancelar</a>
        </div>
    </form>
</main>