    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex m-5 justify-content-around">
                ...
                <span class="record">Sáida 1: <?= $workingHours->time2 ?? '---' ?></span>
            </div>
            <div class="d-flex m-5 justify-content-around">
                <span class="record">Entrada 2: <?= $workingHours->time3 ?? '---' ?></span>
                <span class="record">Sáida 2: <?= $workingHours->time4 ?? '---' ?></span>
            </div>
        </div>
        <div class="card-footer d-flex justify-content-center">
            ...
            <a href="data_generator.php" class="btn btn-warning btn-lg ml-3">
                <i class="icofont-close mr-1"></i>
                Zerar Time
            </a>
        </div>
    </div>
